...
function dropTables($mysqli){
  $drop_authors = "DROP TABLE authors";
  mysqli_query($mysqli, $drop_authors);
  echo mysqli_error($mysqli);
  
  $drop_entity = "DROP TABLE entity";
  mysqli_query($mysqli, $drop_entity);
  echo mysqli_error($mysqli);                  
  
  $drop_initial_entity = "DROP TABLE initial_entity";
  mysqli_query($mysqli, $drop_initial_entity); 
  echo mysqli_error($mysqli);                  
  
  $drop_initial_schedule = "DROP TABLE initial_schedule";
  mysqli_query($mysqli, $drop_initial_schedule);
  echo mysqli_error($mysqli);        
  
  $drop_initial_session = "DROP TABLE initial_session";
  mysqli_query($mysqli, $drop_initial_session);
  echo mysqli_error($mysqli);         
  
  $drop_schedule = "DROP TABLE schedule";
  mysqli_query($mysqli, $drop_schedule);
  echo mysqli_error($mysqli);                
  
  $drop_session = "DROP TABLE session";
  mysqli_query($mysqli, $drop_session);
  echo mysqli_error($mysqli);                 
  
  $drop_sessionChairs = "DROP TABLE sessionChairs";
  mysqli_query($mysqli, $drop_sessionChairs);
  echo mysqli_error($mysqli);           
  
  $drop_transactions = "DROP TABLE transactions";
  mysqli_query($mysqli, $drop_transactions);
  echo mysqli_error($mysqli);            
  
  $drop_users = "DROP TABLE users";
  mysqli_query($mysqli, $drop_users);
  echo mysqli_error($mysqli);   
}  
